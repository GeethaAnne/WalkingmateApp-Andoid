...
public class DistanceDisplay implements StepListener, SpeakingTimer.Listener {
    ...
    public DistanceDisplay(Listener listener, WalkingSettings settings, Utils utils) {
        mListener = listener;
        mUtils = utils;
        mSettings = settings;
        reloadSettings();
