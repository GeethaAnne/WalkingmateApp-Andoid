...
public class StepService extends Service {
    ...
    private DistanceDisplay mDistanceNotifier;
    private SpeedNotifier mSpeedNotifier;
    private Calories mCaloriesNotifier;
    ...
    public void onCreate() {
        ...
        mDistanceNotifier = new DistanceDisplay(mDistanceListener, mPedometerSettings, mUtils);
        ...
        mCaloriesNotifier = new Calories(mCaloriesListener, mPedometerSettings, mUtils);
     ...
     */
    private DistanceDisplay.Listener mDistanceListener = new DistanceDisplay.Listener() {
     ...
     */
    private Calories.Listener mCaloriesListener = new Calories.Listener() {
        public void valueChanged(float value) {
            mCalories = value;
            passValue();
        }
    ...
    private void showNotification() {
        ...
        Notification notification = new Notification(R.drawable.walking1, null,
                System.currentTimeMillis());
        notification.flags = Notification.FLAG_NO_CLEAR | Notification.FLAG_ONGOING_EVENT;
        Intent pedometerIntent = new Intent();
        pedometerIntent.setComponent(new ComponentName(this, WalkingMate.class));
