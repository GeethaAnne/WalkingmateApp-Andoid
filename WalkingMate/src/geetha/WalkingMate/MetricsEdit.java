...
abstract public class MetricsEdit extends EditTextPreference {
	boolean mIsMetric;
	...
	public MetricsEdit(Context context) {
		super(context);
		initPreferenceDetails();
	}
	public MetricsEdit(Context context, AttributeSet attr) {
		super(context, attr);
		initPreferenceDetails();
	}
	public MetricsEdit(Context context, AttributeSet attr, int defStyle) {
